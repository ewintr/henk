...
var styles = map[MessageType]pterm.Color{
	TypeGeneral: pterm.FgGray,
	TypeHenk:    pterm.FgGreen,
	TypeUser:    pterm.FgBlue,
	TypePrompt:  pterm.FgBlue,
	TypeTool:    pterm.FgCyan,
	TypeError:   pterm.FgRed,
	TypeDebug:   pterm.FgRed,
	TypeExit:    pterm.FgYellow,
}
